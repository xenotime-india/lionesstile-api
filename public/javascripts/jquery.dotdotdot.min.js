...
!(function (t, e) {
  ...
  function o(e, n, r, o, d) {
    ...
    var h = s(c),
      ...
      m = g.length - 1;
    for (
      o.fallbackToLetter && 0 == b && 0 == m && ((p = ''), (g = h.split(p)), (m = g.length - 1));
      m >= b && (0 != b || 0 != m);
        ...
        a(r, o)
          ? ((m = w),
            o.fallbackToLetter &&
              0 == b &&
              0 == m &&
              ((p = ''), (g = g[0].split(p)), (v = -1), (w = -1), (b = 0), (m = g.length - 1)))
          : ((v = w), (b = w));
    }
  ...
  function f(t) {
    for (
      var e = t.innerHeight(), n = ['paddingTop', 'paddingBottom'], r = 0, o = n.length;
      o > r;
      r++
    ) {
    ...
    (t.fn.dotdotdot = function (e) {
            ...
            o
              .bind('update.dot', function (e, d) {
                ...
                (l.maxHeight += l.tolerance),
                  'undefined' != typeof d &&
                    (('string' == typeof d || ('nodeType' in d && 1 === d.nodeType)) &&
                ...
                return (
                  s.afterElement &&
                    ((c = s.afterElement.clone(!0)), c.show(), s.afterElement.detach()),
      ...
      return (
        l.lastCharacter.remove instanceof Array ||
          (l.lastCharacter.remove = t.fn.dotdotdot.defaultArrays.lastCharacter.remove),
        l.lastCharacter.noEllipsis instanceof Array ||
          (l.lastCharacter.noEllipsis = t.fn.dotdotdot.defaultArrays.lastCharacter.noEllipsis),
